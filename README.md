...
|[Learn how to reduce costs with AWS Inferentia chips when serving Automatic Speech Recognition models](workshops/04_ReducingCostsWithInferentia)|Learn how to use HuggingFace Optimum Neuron and Manual Porting approaches to compile ASR models and how to deploy them in AWS Inferentia chips.|
